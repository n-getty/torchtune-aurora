#!/bin/bash
#PBS -N lora_mg1024lin
#PBS -A ModCon
#PBS -q debug-scaling
#PBS -l select=2
#PBS -l walltime=00:45:00
#PBS -l filesystems=home:flare
#PBS -o /lus/flare/projects/ModCon/ngetty/torchtune/experiments/lora_grpo/logs/pbs_mg1024lin.out
#PBS -e /lus/flare/projects/ModCon/ngetty/torchtune/experiments/lora_grpo/logs/pbs_mg1024lin.err
...
cd "$TT"
NF="$TT/experiments/lora_grpo/logs/pbs_mg1024lin_nodefile.txt"
sort -u "$PBS_NODEFILE" > "$NF"
echo "=== mg1024lin job up $(date) | jobid=$PBS_JOBID ==="; cat "$NF"
LOG="$TT/experiments/lora_grpo/logs/pbs_mg1024lin.log"
