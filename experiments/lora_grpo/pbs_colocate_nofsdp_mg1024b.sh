...
#PBS -o /lus/flare/projects/ModCon/ngetty/torchtune/experiments/lora_grpo/logs/pbs_mg1024b.out
#PBS -e /lus/flare/projects/ModCon/ngetty/torchtune/experiments/lora_grpo/logs/pbs_mg1024b.err
...
cd "$TT"
NF="$TT/experiments/lora_grpo/logs/pbs_mg1024b_nodefile.txt"
sort -u "$PBS_NODEFILE" > "$NF"
echo "=== mg1024 job up $(date) | jobid=$PBS_JOBID ==="; cat "$NF"
LOG="$TT/experiments/lora_grpo/logs/pbs_mg1024b.log"
