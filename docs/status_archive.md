# Project Status Archive — Aurora RL (torchtune XPU)

Superseded/historical content moved out of `docs/status.md` to keep that file
under capacity. Nothing here was deleted — this is the full prior record.

## Older changelog entries (2026-06-21 back to 2026-04-30)

*Moved from the top of `docs/status.md`'s "Recent changes" section. For newer
entries (2026-07-15 onward) see `docs/status.md` itself.*
