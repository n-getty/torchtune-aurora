...
Last updated: 2026-07-15 (BioReason 32B SFT MFU: XPU fused-flash HW-validated ~2× (10%→~20% MFU); compile +5.8%; 2N HSDP tax SOLVED via ofi; packing HW-REFUTED (flex too slow); AC-off OOMs (activation ceiling — LoRA wouldn't help); **bucketed-bs on flash VALIDATED ~1.49× throughput** — the shippable GEMM/pad lever)
