#!/bin/bash
# Quick test: GRPO on frameworks/2025.3.1 WITHOUT expandable_segments
set -e
...
echo "=== GRPO smoke test: frameworks/2025.3.1, ${NPROC} tiles, ${NSTEPS} steps ==="
echo "Node: $(hostname), Torch: $(python3 -c 'import torch; print(torch.__version__)')"
